...
var drop = function drop() {
  ...
  var postFiles = function postFiles(url, data) {
    var res;
    return regeneratorRuntime.async(function postFiles$(_context) {
      while (1) {
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      ...
      var dots; // console.log(input.files);

      var arr = input.files[0].name.split('.'); // console.log(arr);

      fetch('assets/server.php').then(function (res) {
        console.log(res);
...
var filter = function filter() {
  var menu = document.querySelector('.portfolio-menu'),
      ...
      btnGrandMo = menu.querySelector('.grandmother'),
  ...
  btnGrandMo.addEventListener('click', function () {
    typeFilter();
  });
...
var showMoreStyles = function showMoreStyles(trigger, wrapper) {
  ...
  btn = document.querySelector(trigger); // cards.forEach(card => {
